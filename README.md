...
😊 안녕하세요
   <br>
가치있는 인사이트를 발굴중인 예비 데이터분석가 황보유리입니다.
   <br>
   <h4 style="border-bottom"> ✨ Tech Stack </h4>
   <img alt="MySQL" src ="https://img.shields.io/badge/MySQL-white.svg?&style=flat&logo=MySQL&logoColor=4479A1"/>
   <img alt="Python" src ="https://img.shields.io/badge/Python-3776AB.svg?&style=flat&logo=Python&logoColor=white"/>
   <img alt="Tableau" src ="https://img.shields.io/badge/Tableau-white.svg?&style=flat&logo=Tableau&logoColor=4479A1"/>
   <br>

   
   <br>
   <h4 style="border-bottom">🛠 Tools </h4>
